...
Public Class Studio
    ...
    Private Sub CodeEditor_TextChanged(sender As Object, e As FastColoredTextBoxNS.TextChangedEventArgs) Handles CodeEditor.TextChanged, CodeEditor.Validated
